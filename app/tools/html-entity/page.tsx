  ...
  return (
    <ToolLayout title="HTML Entity Encode / Decode" description="Encode special characters to HTML entities or decode them back.">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
        <textarea value={input} onChange={e => process(e.target.value, mode)} className="w-full h-48 font-mono text-sm border border-gray-300 rounded-xl p-4 focus:ring-2 focus:ring-indigo-400 resize-none" placeholder={mode === 'encode' ? '<div class="hello">' : '&lt;div class=&quot;hello&quot;&gt;'} />
